    ...
    <>
      <HeaderBar>
        <Container>
          ...
          <RightGroup>
            ...
            <CvButton href="/cv.pdf" download="Zikreddin-Sik-CV.pdf" target="_blank" rel="noopener noreferrer">
              CV İndir
            </CvButton>
      ...
      {showQuote && (
        <QuoteOverlay onClick={() => setShowQuote(false)} role="presentation">
          ...
          >
            <QuoteClose type="button" onClick={() => setShowQuote(false)} aria-label="Kapat">
              <AiOutlineClose size="1.8rem" />
            </QuoteClose>
            <QuotePortraitWrap>
              <QuotePortrait src="/images/quote-portrait.webp" alt="Zikreddin Şık konuşurken" />
            </QuotePortraitWrap>
            <QuoteContent>
